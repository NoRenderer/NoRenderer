...
def main():
    ...
    t.gen_text("Copyright (C) 2023, \x1b[31mRender Softworks Inc.\x1b[0m", 2)
    ...
    ⸻⸻⸻
    \x1b[96mOS:     \x1b[93mNixOS, Arch Linux, Windows 10, Android\x1b[0m
    ...
    t.gen_typing_text(" -u NoRenderer", 1, contin=True)
